...
{
    public class WaveCaster : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wave Caster");
            Tooltip.SetDefault("Rain Down Holy Water");
        }
        public override void SetDefaults()
        {
            item.shoot = ModContent.ProjectileType<WaveCasterProjectile>();
            item.useStyle = ItemUseStyleID.SwingThrow;
            item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/WaveCasterSound");
            item.shootSpeed = 8f;
            item.width = 50;
            item.height = 54;
            item.damage = 340;
